...
//
//   Future<void> refreshEvents() async {
//     laterEventsList.value = await sqlHelper.getEvents();
//   }
//
//   @override
//   Widget build(BuildContext context) {
...
//               final now = DateTime.now();
//               // final now = DateTime.now()
//               //     .add(const Duration(days: 2)); // simulate 2 days later
//
//               final filteredLaterEvents = laterEventsList.where((event) {
//                 final laterEventDateTime =
//                     DateTime.parse('${event.date} ${event.time}');
//                 return laterEventDateTime.isAfter(now) &&
//                     laterEventDateTime
//                         .isAfter(now.add(const Duration(days: 10)));
//               }).toList()
//                 ..sort((a, b) {
//                   final aDateTime = DateTime.parse('${a.date} ${a.time}');
//                   final bDateTime = DateTime.parse('${b.date} ${b.time}');
...
//                 });
//
//               return filteredLaterEvents.isEmpty
//                   ? SliverFillRemaining(
//                       child: Center(
//                         child: Shimmer.fromColors(
//                           baseColor: AppColors.darkColor,
